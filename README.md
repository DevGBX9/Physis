...
To ensure forests grow naturally and do not overrun the world instantly, trees behave differently depending on their location within a grove.
...
Soil fertility plays a massive role in successful expansion. Richer soils provide mathematical bonuses to growth chances: Podzol (+35%), Moss (+30%), Rooted Dirt (+20%), and Grass (+10%). Furthermore, the presence of decaying organic matter, such as nearby dead bushes or fallen leaves, acts as a natural fertilizer, providing an additional minor boost to fertility.
...
| :--- | :--- | :--- | :--- | :--- |
| **Grass** | 10% | 6 per 5x5 area | Tolerates clustering | The primary ground cover, spreading quickly across open terrain. |
| **Bushes** | 7% | 10 per 5x5 area | Can cluster tightly | Forms dense, cozy thickets in the landscape. |
| **Ferns** | 3% | 4 per 5x5 area | Requires 20-30 block separation | Spreads slowly and jumps to distant spots to form new patches. |
| **Flowers** | 1% | 3 per 5x5 area | Requires 10+ block separation | Rare and precious, forming small, isolated clusters. |
...
*   **Modrinth:** [modrinth.com/mod/physis](https://modrinth.com/mod/physis)
*   **GitHub:** [github.com/DevGBX9/Physis](https://github.com/DevGBX9/Physis)
